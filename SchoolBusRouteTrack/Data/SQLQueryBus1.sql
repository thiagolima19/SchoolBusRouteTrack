...
-- Insert Drivers with ALL information (Calgary area coordinates)
INSERT INTO Driver (FullName, Phone, Status, Latitude, Longitude, Address, VehicleID)
VALUES
('Thiago Lima', '403-999-1000', 'Active', 
 51.0452, -114.0630, '123 Centre St NW, Calgary, AB T2G 0B1', 1),

('Bruno Martins', '403-999-2000', 'Active', 
 51.0355, -114.0745, '456 8 Ave SW, Calgary, AB T2P 1E1', 2),

('Patricia Diniz', '403-999-3000', 'Active', 
 51.0420, -114.0578, '789 4 St SW, Calgary, AB T2P 3E4', 3),

('Marianna Rangel', '403-999-4000', 'Active', 
 51.0388, -114.0662, '321 6 Ave SW, Calgary, AB T2P 3E7', 4),

('Daniela Freire', '403-999-5000', 'Active', 
 51.0485, -114.0703, '654 10 St NW, Calgary, AB T2N 1V6', 5);
GO
...
(2, 4, 1), (2, 5, 2), (2, 6, 3), (2, 1, 4), (2, 2, 5),
(3, 7, 1), (3, 8, 2), (3, 9, 3), (3, 3, 4), (3, 2, 5),
(4, 10, 1), (4, 6, 2), (4, 5, 3), (4, 8, 4), (4, 7, 5),
(5, 2, 1), (5, 3, 2), (5, 7, 3), (5, 9, 4), (5, 10, 5),
(6, 1, 1), (6, 2, 2), (6, 3, 3), (6, 4, 4), (6, 5, 5),
(7, 4, 1), (7, 5, 2), (7, 6, 3), (7, 1, 4), (7, 2, 5),
